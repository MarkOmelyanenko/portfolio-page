    ...
    <footer className="bg-gray-950 text-white py-12 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-cyan-400 hover:bg-cyan-400 hover:text-gray-900 transition-colors"
                  title={social.name}
                >
                  {social.icon}
                </motion.a>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>© {currentYear} Mark Omelyanenko. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
